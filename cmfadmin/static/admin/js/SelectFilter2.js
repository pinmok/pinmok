...
'use strict';
{
    window.SelectFilter = {
        init: function (field_id, field_name, is_stacked) {
            ...
            selector_available.className = 'selector-available form-fieldset bg-lime-lt';
            ...
            const search_filter_label = quickElement('label', filter_p, '', 'for', field_id + '_input', 'class', 'form-label');
            ...
            const filter_input = quickElement('input', filter_p, '', 'type', 'text', 'placeholder', gettext("Filter"), 'class', 'form-control');
            ...
            selector_chosen.className = 'selector-chosen form-fieldset  bg-cyan-lt';
            ...
            const filter_selected_input = quickElement('input', filter_selected_p, '', 'type', 'text', 'placeholder', gettext("Filter"), 'class', 'form-control');
