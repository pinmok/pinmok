...
from pinmok.padmin.constants import HUGERTE_LANG_MAP
from pinmok.padmin.enums import ImageWidgetMode


class PinmokWidgetMixin:
    """
    Base mixin for all Pinmok Widgets.
...
class PinmokTextInput(PinmokWidgetMixin, forms.TextInput):
    pass


class PinmokEmailInput(PinmokWidgetMixin, forms.EmailInput):
    pass


class PinmokURLInput(PinmokWidgetMixin, AdminURLFieldWidget):  # forms.URLInput):
    pass


class PinmokNumberInput(PinmokWidgetMixin, forms.NumberInput):
    pass


class PinmokUUIDInput(PinmokWidgetMixin, AdminUUIDInputWidget):
    pass


class PinmokDecimalInput(PinmokWidgetMixin, forms.NumberInput):
...
class PinmokGenericIPAddress(PinmokWidgetMixin, forms.TextInput):
    def __init__(self, attrs=None):
        attrs = {
...
class PinmokTextarea(PinmokWidgetMixin, forms.Textarea):
    def __init__(self):
        super().__init__(attrs={"rows": "3"})


class PinmokPassword(PinmokWidgetMixin, forms.PasswordInput):
    pass


class PinmokSelect(PinmokWidgetMixin, forms.Select):
    default_css_class = 'form-select'


class PinmokSelectMultiple(PinmokWidgetMixin, forms.SelectMultiple):
    default_css_class = 'form-select'


class PinmokSelectTags(forms.SelectMultiple):
    def __init__(self, *args, attrs=None, **kwargs):
        # Set default class; user-provided attrs will override defaults
...
# Checkbox / Radio
class PinmokCheckbox(PinmokWidgetMixin, forms.CheckboxInput):
    default_css_class = 'form-check-input'


class PinmokSwitch(PinmokWidgetMixin, forms.CheckboxInput):
    default_css_class = 'form-check-input'
    template_name = 'forms/widgets/checkbox_switch.html'


class PinmokCheckboxSelectMultiple(PinmokWidgetMixin, forms.CheckboxSelectMultiple):
...
class PinmokRadioSelect(PinmokWidgetMixin, AdminRadioSelect):
    default_css_class = 'form-check-input'
    option_template_name = 'forms/widgets/input_option.html'


class PinmokForeignKeyRawId(PinmokWidgetMixin, ForeignKeyRawIdWidget):
    pass


class PinmokManyToManyRawId(PinmokWidgetMixin, ManyToManyRawIdWidget):
    def get_context(self, name, value, attrs):
...
class PinmokAutocompleteMixin(AutocompleteMixin):
...
class PinmokAutocompleteSelect(PinmokAutocompleteMixin, forms.Select):
    pass


class PinmokAutocompleteSelectMultiple(PinmokAutocompleteMixin, forms.SelectMultiple):
    pass


class PinmokFileInput(PinmokWidgetMixin, AdminFileWidget):
    template_name = "admin/widgets/clearable_file_input.html"


class PinmokImageFileInput(Widget):
    """
    ...
    def get_context(self, name, value, attrs):
        ...
        context['widget']['upload_url'] = reverse('admin:padmin:upload_file')
...
class BasePinmokDateTimeMixin(PinmokWidgetMixin):
...
class PinmokDateInput(BasePinmokDateTimeMixin, forms.DateInput):
    input_type = 'date'
    icon_name = 'tabler-calendar'
    format = '%Y-%m-%d'


class PinmokTimeInput(BasePinmokDateTimeMixin, forms.TimeInput):
    input_type = 'time'
    icon_name = 'tabler-clock-hour'
    format = '%H:%M'


class PinmokDateTimeInput(BasePinmokDateTimeMixin, forms.DateTimeInput):
...
class ResourceWidget(PinmokForeignKeyRawId):
    """
...
class PinmokDatalistInput(PinmokWidgetMixin, forms.TextInput):
    """
