...
Description:
  Three-layer architecture for reading and writing Pinmok configuration:
...
from pinmok.padmin.constants import PINMOK_CONFIG_CACHE_TTL
from pinmok.padmin.enums import ConfigType
from pinmok.padmin.models import Config
...
class ConfigCache:
    ...
    _KEY_PREFIX = "pinmok_cfg"
    _CAT_PREFIX = "pinmok_cfg_cat"
    ...
    def set(self, category: str, key: str, raw_value: str) -> None:
        cache.set(self._key(category, key), raw_value, timeout=PINMOK_CONFIG_CACHE_TTL)
    ...
    def set_category(self, category: str, data: dict[str, str]) -> None:
        cache.set(self._cat_key(category), data, timeout=PINMOK_CONFIG_CACHE_TTL)
...
class ConfigService:
    """
    Public API for reading and writing Pinmok configuration.
