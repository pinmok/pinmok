...
Description:
  Custom form fields for Pinmok admin.

  Provides reusable field classes that extend Django's built-in form fields
  to support Pinmok-specific UI patterns.
Author:
  惠达浪 <crazys@126.com>
Created:
  2026/3/22
...
from pinmok.core.libs.tree import T
...
class PinmokImagePathField(forms.CharField):
    """
    A CharField that accepts image file paths produced by PinmokImageFileInput
