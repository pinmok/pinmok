...
from pinmok.cmfadmin.enums import ImageWidgetMode
from pinmok.cmfadmin.fields import CMFImagePathField
from pinmok.cmfadmin.service.config import ConfigService
...
class CMFModelAdminMixin(BaseModelAdmin):
    ...
    def action_form(self):
        ...
        """
        from pinmok.cmfadmin.forms.forms import CMFActionForm
    ...
    def formfield_for_foreignkey(self, db_field, request, **kwargs):
        ...
        from pinmok.cmfadmin.models import Resource  # avoid circular import
...
class ConfigModelAdmin(CMFModelAdminMixin, ModelAdmin):
    ...
    def get_form_class(self):
        from pinmok.cmfadmin.forms.config_forms import ConfigForm
